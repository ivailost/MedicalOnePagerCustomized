...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><h5>Email Sent Successfully.</h5><p>Thank you $name, your message has been submitted to us.</p></div></fieldset>"; }